...
def find_seal_headers_dir():
    ...
    if not found:
        print(
            "Cannot find SEAL library in {} make sure that "
...
def find_boost_headers_dir():
    ...
    if not found:
        print(
            "Cannot find boost library in {} make sure that "
...
class BuildExt(build_ext):
    ...
    def build_extensions(self):
        ...
        for ext in self.extensions:
            ...
            if not self._add_extra_compile_arg(
            ...
            self._add_extra_compile_arg(
                '-DPROJECT_ROOT_DIR="' + PROJECT_ROOT_DIR + '"', ext.extra_compile_args
            )
